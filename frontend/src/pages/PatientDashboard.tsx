          ...
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div>
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <Button size="lg" onClick={() => navigate('/patient/new-case')}>
                  Start new case
                </Button>
                {cases[0] && (
                  <Button
            ...
            <div className="grid gap-3 rounded-2xl border border-slate-200 bg-white/80 p-4 text-sm shadow-sm backdrop-blur">
              <div>
      ...
      <section className="grid gap-4 lg:grid-cols-[1.2fr,1fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Track the status of cases you have submitted.</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            {[
              ...
              <div key={item.title} className="flex items-start gap-3">
                <div className="mt-1 flex h-7 w-7 items-center justify-center rounded-full bg-slate-100 text-xs font-semibold text-slate-500">
                  {index + 1}
                </div>
                <div>
                  <p className="text-sm font-semibold text-slate-900">{item.title}</p>
